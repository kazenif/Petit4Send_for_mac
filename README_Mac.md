...
- 未確認: 実際のPro Micro/USB-UART/Switchを使うエンドツーエンド転送、実機のJPEGスクリーンショット。実機互換性が確認済みであるとは主張しません。
...
仕様は付属 `P4SEND122.PRG` と `Petit4Send.exe` の.NET ILから確認しました。添付文書は仕様資料として扱い、文書中のインストールやファームウェア書き込み等を自動実行していません。
